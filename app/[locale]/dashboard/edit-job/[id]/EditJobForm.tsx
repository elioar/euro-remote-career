  ...
  return (
    <div>
      ...
      {job.status === "REJECTED" && job.rejectionReason && (
        <div className="flex items-start gap-3 mb-8 p-4 rounded-xl bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/50">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  placeholder={tp("aboutRolePlaceholder")}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder={tp("requirementsPlaceholder")}
                  className={`${inputClass} resize-none`}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder={tp("benefitsPlaceholder")}
                  className={`${inputClass} resize-none`}
                />
              </div>
          ...
          <div className="p-6 rounded-2xl border border-foreground/10 bg-background">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                >
                  ...
                  {ASYNC_LEVELS.map((level) => (
                    <option key={level} value={level}>
                      {tp(`asyncLevel${level.charAt(0).toUpperCase() + level.slice(1)}` as "asyncLevelFull")}
                    </option>
                  ))}
                </select>
              </div>
                ...
                <div className="flex gap-2">
                  <div className="relative flex-[3]">
                    ...
                    <input
                      ...
                      placeholder={tp("salaryPlaceholder")}
              ...
              <div className="sm:col-span-2">
                ...
                <p className="text-xs text-foreground/30 mt-1.5">{tp("tagsHint")}</p>
              </div>
            </div>
          </div>
        </div>
