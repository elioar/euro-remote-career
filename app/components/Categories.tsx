          ...
          {categories.map((cat, i) => (
            ...
            >
              <Link
                ...
                className="block rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-shadow hover:border-gray-300 hover:shadow-lg sm:p-6"
              >
                <motion.span
                  className="block"
                  whileHover={{ y: -2 }}
                ...
                >
                  <h3 className="font-semibold text-navy-primary">{cat.title}</h3>
