          ...
          {jobs.map((job, i) => (
            ...
            >
              <div className="flex flex-wrap items-center gap-2">
                <span className="rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-700 dark:bg-slate-700 dark:text-slate-300">
                  Remote
                </span>
              </div>
              ...
              <p className="mt-3 text-sm text-gray-600 dark:text-slate-300">{job.description}</p>
