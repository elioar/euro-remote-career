        ...
        >
          ...
          >
            ...
            <ul className="mt-6 space-y-6">
              <li>
                <span className="text-sm font-medium text-slate-500 dark:text-slate-400">General & jobs</span>
                <motion.a
              ...
              <li>
                <span className="text-sm font-medium text-slate-500 dark:text-slate-400">Employers</span>
                <motion.a
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <motion.div whileHover={{ x: 4 }}>
                  <Link
                    href="/about"
                    className="text-navy-primary hover:text-navy-hover inline-block dark:text-blue-400 dark:hover:text-blue-300"
                  >
                    About us →
                  </Link>
                </motion.div>
                <p className="mt-0.5 text-sm text-slate-600 dark:text-slate-400">Mission, how it works, FAQ.</p>
              </li>
              <li>
                <motion.div whileHover={{ x: 4 }}>
                  <Link
                ...
                <p className="mt-0.5 text-sm text-slate-600 dark:text-slate-400">Curated remote & async roles.</p>
              </li>
              <li>
                <motion.div whileHover={{ x: 4 }}>
                  <Link
                ...
                <p className="mt-0.5 text-sm text-slate-600 dark:text-slate-400">How we handle your data.</p>
              </li>
            </ul>
          </motion.section>
        </motion.div>
