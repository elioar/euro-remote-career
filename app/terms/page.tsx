    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-2xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-700 dark:text-slate-300">
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">1. Acceptance</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">2. Use of the site</h2>
            <p className="mt-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">3. Job listings and applications</h2>
            <p className="mt-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">4. No employment relationship</h2>
            <p className="mt-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">5. Intellectual property</h2>
            <p className="mt-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">6. Links to third parties</h2>
            <p className="mt-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">7. Limitation of liability</h2>
            <p className="mt-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">8. Changes</h2>
            <p className="mt-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">9. Governing law</h2>
            <p className="mt-2 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#0E1A2B] dark:text-slate-100">10. Contact</h2>
            <p className="mt-2 leading-relaxed">
